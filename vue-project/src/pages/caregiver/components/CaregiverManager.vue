<template>
  <el-dialog v-model="visible" title="护工信息管理" width="500" center="true">
    <el-form ref="formRef" :model="caregiver" :rules="rules" label-width="100px">
      <el-form-item label="姓名" prop="name">
        <el-input v-model="caregiver.name" placeholder="请输入护工姓名" width="300px" />
      </el-form-item>
      <el-form-item label="身份证" prop="identificationCard">
        <el-input v-model="caregiver.identificationCard" placeholder="请输入护工身份证" />
      </el-form-item>
      <el-form-item label="性别">
        <el-select v-model="caregiver.sex">
          <el-option label="男" value="男" />
          <el-option label="女" value="女" />
        </el-select>
      </el-form-item>
      <el-form-item label="状态">
        <el-select v-model="caregiver.state">
          <el-option label="在职" value="1" />
          <el-option label="不在职" value="0" />
        </el-select>
      </el-form-item>

      <el-form-item label="护工级别">
        <el-select v-model="caregiver.grade">
      ...
      <el-form-item label="工作年限" prop="workYears">
        <el-input-number v-model="caregiver.workYears" :min="1" :max="50" controls-position="right" />
      </el-form-item>
